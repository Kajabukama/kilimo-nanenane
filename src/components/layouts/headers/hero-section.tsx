...
import cover from "/public/assets/images/nanenane.jpg";
...
const HeroSection = () => {
  return (
    <div className="relative h-[70vh] z-20">
      ...
      />
      <div className="absolute hidden flex-col top-20 left-32 max-w-screen-lg w-full z-10 px-20  bg-primary/70">
